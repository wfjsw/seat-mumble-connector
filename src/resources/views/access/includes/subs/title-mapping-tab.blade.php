<table class="table table-condensed table-hover table-responsive">
    ...
    @foreach($title_filters as $filter)
        <tr>
            ...
            <td>
                <div class="btn-group">
                    <a href="{{ route('mumble-connector.title.remove', ['corporation_id' => $filter->corporation_id, 'title_id' => $filter->title_id, 'mumble_role' => $filter->mumble_role]) }}" type="button" class="btn btn-danger btn-xs col-xs-12">
