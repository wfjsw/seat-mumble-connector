...
/**
 * Class MumbleRoleTitle
 * @package WinterCo\Connector\Mumble\Models
 */
class MumbleRoleTitle extends Model
{
     ...
     * @var string
     */
    protected $table = 'winterco_mumble_connector_role_titles';

    /**
     * @var array
     */
    protected $primaryKey = [
        'corporation_id', 'title_id', 'mumble_role',
    ];
     ...
     */
    protected $fillable = [
        'corporation_id', 'title_id', 'mumble_role', 'enabled',
    ];
